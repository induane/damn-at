...
def main():  # pylint: disable=R0914,R0912,R0915
    ...
    def get_file_id(obj):
        """
        If the object is in a library, return a file for it, else return this
        fileid.
        """
        if obj.library:
    ...
    for image in bpy.data.images:
        ...
        asset_descr = AssetDescription(asset=AssetId(subname=image.name,
    ...
    for text in bpy.data.texts:
        ...
        asset_descr = AssetDescription(asset=AssetId(subname=text.name,
