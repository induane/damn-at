...
class BlenderCameraTranscoder(ITranscoder):
    options = [IntVectorOption(name='size', description='The target size of the image', size=2, min=1, max=4096, default=(64, ))]
    convert_map = {
        "application/x-blender.object-camera": {"image/jpg": options},
